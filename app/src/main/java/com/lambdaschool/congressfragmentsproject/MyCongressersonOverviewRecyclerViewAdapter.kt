...
import kotlinx.android.synthetic.main.fragment_congressersonoverview.view.*
 ...
 */
class MyCongressersonOverviewRecyclerViewAdapter(
    private val mValues: List<CongresspersonOverview>,
    private val mListener: OnListFragmentInteractionListener?
) : RecyclerView.Adapter<MyCongressersonOverviewRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.fragment_congressersonoverview, parent, false)
